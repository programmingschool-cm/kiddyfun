...
(function () {
  ...
  var SNIPPETS = [
    ...
    { k: 'game', insert: 'game "My Game"', label: 'game', detail: '🎮 Game mode', score: 76 },
    { k: 'every frame', insert: 'every frame\n    \nend', label: 'every frame', detail: '🎮 Game loop', score: 75 },
    { k: 'when', insert: 'when space is pressed\n    \nend', label: 'when key pressed', detail: '🎮 Jump / action', score: 74 },
    { k: 'is player', insert: 'is player', label: 'is player', detail: '🎮 Set player', score: 70 },
